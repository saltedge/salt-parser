...
describe OFX::Accounts do
  let(:sample_ofx)            { OFX::Parser::Base.new("spec/ofx/fixtures/sample_examples/sample_investment.qfx") }
  let(:hewitt_ofx)            { OFX::Parser::Base.new("spec/ofx/fixtures/investments_with_mkval.ofx") }
  let(:merrill_lynch_ofx)     { OFX::Parser::Base.new("spec/ofx/fixtures/investment_transactions_response3.ofx") }
  let(:vanguard_ofx)          { OFX::Parser::Base.new("spec/ofx/fixtures/investment_transactions_response4.ofx") }
  ...
  describe "accounts" do
    it "should return sample account" do
      ...
      account.type.should      == OFX::Parser::BaseParser::ACCOUNT_TYPES["INVESTMENT"]
    ...
    describe "#find" do
      it "returns first by id" do
        sample_accounts.find("1234567890").class.should == OFX::Account
      end
    end
